...
class ShapesConfig:
    ...
    def logic_init(self):
        ...
        self.PATH_SAVE_DATA = os.path.join(".", self.ADDED_PREFIX + "output" +"_"+str(self.OVERLAPING_MAX_IOU)+  "_"+str(self.IS_CONST_COLOR_SHAPES) + "_" + str(self.IS_BG_UNIFIED))
